export function Footer() {
  return (
    <footer className="bg-[#2B2520] text-[#C9BEB0]">
      <div className="max-w-[1400px] mx-auto px-8 py-14">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div>
            <div className="text-2xl text-white mb-4 tracking-tight font-medium">RoomMuse</div>
            <p className="text-sm leading-relaxed text-[#B5A394]">
        ...
        <div className="pt-8 border-t border-[#3D352E] flex flex-col md:flex-row justify-between items-center gap-4">
