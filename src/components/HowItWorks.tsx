...
const steps = [
  {
    ...
    description:
      "Upload products individually or in bulk via CSV. We map products into a design-ready library.",
  ...
  },
  {
    ...
    description:
      'Install our lightweight plugin on your product pages. A "View in AR" button appears on each furniture detail page. Customers click the button and scan a QR code to launch AR instantly on their phone.',
    details: [],
    visual: arPluginGif,
  ...
  },
  {
    ...
    description:
      "Watch how customers transform empty rooms into beautifully designed spaces using your furniture catalog.",
    details: [
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-8">
        ...
        <div className="max-w-[1200px] mx-auto space-y-20">
          {steps.map((step, index) => (
            <div
              key={index}
              className={`grid gap-16 items-center lg:grid-cols-2 ${index % 2 === 1 ? "lg:grid-flow-dense" : ""} ${step.type === "video" || step.type === "dashboard" ? "min-h-[500px]" : ""}`}
            >
              {/* Content */}
                  ...
                  <div className="space-y-3">
                    {step.details.map((detail, idx) => (
                      <div key={idx} className="flex items-center gap-3">
                        ...
                        <span className="text-[#6F746B] text-lg font-medium">
                          {detail}
                        </span>
                      </div>
                    ))}
              ...
              {/* Visual */}
              <div
                className={`relative flex justify-center ${step.type === "video" || step.type === "dashboard" ? "items-start" : "items-center"} ${index % 2 === 1 ? "lg:col-start-1 lg:row-start-1" : ""}`}
              >
                {step.type === "image" && (
